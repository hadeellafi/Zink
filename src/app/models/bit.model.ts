...
export class Bit {
  ...
  private static MapTaste(taste: string): EnumTaste {
    ...
    switch (taste.toUpperCase()) {
      case 'SWEET': return EnumTaste.SWEET;
      case 'SOUR': return EnumTaste.SOUR;
      case 'BITTER': return EnumTaste.BITTER;
      case 'SALTY': return EnumTaste.SALTY;
      case 'UMAMI': return EnumTaste.UMAMI;

      default: return EnumTaste.NOTASTE; // nave a defaut
    }
  }
}
